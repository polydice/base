...
RUN apt-get update && apt-get install -y build-essential apt-transport-https cmake python git libpq-dev libxml2-dev libsasl2-dev graphicsmagick yarn=0.24.5-1 libxslt1-dev --no-install-recommends && rm -rf /var/lib/apt/lists/*
